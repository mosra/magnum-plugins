...
# to find the original source files in build/.../CMakeFiles/src/MagnumPlugins
# and results in a zero-byte coverage being happily uploaded, with no error
# message produced whatsoever. How nice.
