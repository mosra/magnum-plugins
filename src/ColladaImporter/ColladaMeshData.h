#ifndef Magnum_Plugins_ColladaImporter_ColladaMeshData_h
#define Magnum_Plugins_ColladaImporter_ColladaMeshData_h
/*
...
/** @file
 * @brief Class Magnum::Plugins::ColladaImporter::ColladaMeshData
 */
