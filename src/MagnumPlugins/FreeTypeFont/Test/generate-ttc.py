...
# Generates Oxygen.ttc from Oxygen.subset.ttf. The second face is identical
# except for the character map, where 'W' resolves to glyph 3 instead of 1. To
# avoid having another 100 kB font as part of the test data, the subset file
# is made out of Oxygen.ttf with
