#!/usr/bin/env python3
#
# Generates Oxygen.collection.ttc from Oxygen.ttf. The second face is identical
# except for the character map, where 'W' resolves to glyph 72 instead of 58.

from pathlib import Path
import struct


Source = Path(__file__).with_name("Oxygen.ttf")
Destination = Path(__file__).with_name("Oxygen.collection.ttc")
