...
# are used to manually create the mipmaps. Those are the only files that aren't
# generated by either this script or by KtxImporter/KtxImageConvert with
# --save-diagnostic. Horrible hack, but it's better than nothing.
